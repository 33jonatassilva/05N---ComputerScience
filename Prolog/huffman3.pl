...
/*
- Escreve no arquivo o texto codificado no formato sem vírgulas e colchetes 
*/
escrever_codificado_sem_virgula_e_colchetes(Arquivo, Codificado) :-
    open(Arquivo, write, Fluxo),
    escrever_sem_virgula_e_colchetes(Fluxo, Codificado),
    close(Fluxo).

escrever_sem_virgula_e_colchetes(_, []).
escrever_sem_virgula_e_colchetes(Fluxo, [Codigo|Codigos]) :-
    write(Fluxo, Codigo),    % Escreve cada código sem vírgula
    escrever_sem_virgula_e_colchetes(Fluxo, Codigos).

/* 
- Executa um teste completo, codificando e escrevendo no formato sem vírgulas e colchetes
*/
huffman :-
    amostra(Texto),
    ...
    % Escrever texto codificado no arquivo sem vírgulas e colchetes
    escrever_codificado_sem_virgula_e_colchetes('out.txt', Codificado),
